...
select substr('Hello World', 1, 5) from dual;  --문자열 자르기 (첫번재 글자부터 5개) 'Hello'
...
--결합연산자 ||
select uname || '의 평균은 ' || aver || '점입니다' from sungjuk;
select uname || '의 평균은 ' || aver || '점입니다' as str from sungjuk;
...
--두개의 날짜데이터에서 개월 수 계산
select months_between('2023-08-22', '2023-10-30') from dual;   --  9.7
...
select to_date('2023-08-27')  - to_date('2023-05-30') from dual;   --89일
